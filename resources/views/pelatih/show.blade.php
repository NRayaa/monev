            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <h2>{{ $detailPelatih->name_pelatih }}</h2>
                        <h3>Pelatih {{ $detailPelatih->cabor_pelatih }}</h3>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $detailPelatih->name_pelatih }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Pelatih Cabang Olahraga</div>
                                    <div class="col-lg-9 col-md-8">{{ $detailPelatih->cabor_pelatih }}</div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="name_pelatih" type="text" class="form-control" id="fullName"
                                                value="{{$detailPelatih->name_pelatih}}">
                                        </div>
                                    </div>
