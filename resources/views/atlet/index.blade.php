        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end align-items-center">
                    <a href="{{ route('atlet.create') }}" type="button" class="btn btn-primary"><i class="bi bi-plus me-1"></i> Tambah</a>
                </div>
            </div>
                ...
                <tbody>
                    @foreach ($atlets as $atlet)
                        <tr>
                            ...
                            <td><a href="{{ route('atlet.show', $atlet->id) }}" class="btn btn-warning"><i
